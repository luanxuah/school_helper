...
import com.luanxu.bean.TestGetAndPostBean;
import com.luanxu.bean.TestUploadBean;
import com.luanxu.utils.GsonUtil;
import com.luanxu.utils.LoaderImageUtil;
import com.luanxu.utils.LogUtil;
import com.luanxu.utils.okhttp.OkHttpUtil;
...
public class ExampleActivity extends Activity {
    ...
    public void onPost(View view) {
        Map<String,String> params = new HashMap<>();
        params.put("partyId", "12301");
        params.put("partyClient", "appTypeEnum_0");
        params.put("content", "哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈");
        params.put("chtTypeEnum", "chtTypeEnum_1");
        OkHttpUtil.post(mContext,"http://192.168.1.24:9090/sysCommon/control/restful/ajaxAddCaseHistoryTopic", params, new Callback<String>() {
...
//                TestGetAndPostBean testBean = GsonUtil.json2Object(body,new TypeToken<TestGetAndPostBean>(){});
            ...
            @Override
            public void onResponse(String testBean, int id) {
            ...
            @Override
            public void onError(Call call, Exception e, int id) {
                LogUtil.e("TestBean:异常"+e.toString());
            ...
            public void onResponse(TestUploadBean uploadBean, int id) {
                if (uploadBean != null) {
                    if ("1".equals(uploadBean.getStatus())) {
                        LoaderImageUtil.displayFromNet(uploadBean.getOutputList().get(0),R.mipmap.test,iv_img);
                    }
                }
            }
