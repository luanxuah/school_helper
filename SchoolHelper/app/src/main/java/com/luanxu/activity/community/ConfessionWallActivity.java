...
import com.luanxu.adapter.community.ConfessionWallAdapter;
 ...
 * @className:  ConfessionWallActivity
 * @Description: 表白墙
 */

public class ConfessionWallActivity extends BaseActivity{
    //上下文对象
    private Activity context;
    //列表
    private PullToRefreshListView list;
    //列表适配器
    private ConfessionWallAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.setTitle(getResources().getString(R.string.str_confession_wall), R.color.color_white);
        bar.setBack();
    ...
    private void init(){
        ...
        adapter = new ConfessionWallAdapter(context);
